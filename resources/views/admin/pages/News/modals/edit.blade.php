                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-8">
                            ...
                            <div class="form-group mt-3">
                                <label for="form-title-edit" class="form-label">Title</label>
                                <input type="text" name="title" class="form-control form-input-edit" id="form-title-edit"
                                    required>
                                <div class="invalid-feedback" id="error-title-edit">
                                </div>
                            </div>
                            <div class="form-group mt-3">
